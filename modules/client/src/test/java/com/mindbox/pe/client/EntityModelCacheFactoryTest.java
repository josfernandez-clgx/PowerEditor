...
public class EntityModelCacheFactoryTest extends AbstractTestWithGenericEntityType {
	...
	public void testFindGenericEntityWithNullEntityTypeThrowsNullPointerException() throws Exception {
		assertThrowsNullPointerException(EntityModelCacheFactory.getInstance(), "findGenericEntity", new Class[] { GenericEntityType.class, String.class }, new Object[] { null, "" });
	}
	...
	public void testFindGenericCategoryWithNullEntityTypeThrowsNullPointerException() throws Exception {
		assertThrowsNullPointerException(EntityModelCacheFactory.getInstance(), "findGenericCategoryByName", new Class[] { GenericEntityType.class, String.class }, new Object[] { null, "" });
	}
	...
	public void testGetCategoryToEntityAssociationsByCategoryThrowsNullPointer() throws Exception {
		GenericCategory category = createGenericCategory(entityType);
		assertThrowsNullPointerException(EntityModelCacheFactory.getInstance(), "getCategoryToEntityAssociationsByCategory", new Class[] { GenericCategory.class }, new Object[] { category });
	}
