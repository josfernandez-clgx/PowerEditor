...
public class ExcelAdapterTest extends AbstractClientTestBase {
	...
	public void setUp() throws Exception {
		...
		attachColumnDataSpecDigest(template.getColumn(1));
		attachColumnDataSpecDigest(template.getColumn(2));
	...
	public void testCopyWithEnumValuesSetsClipbaordWithDisplayLabel() throws Exception {
		...
		gridTable.setColumnSelectionInterval(0, 0);
		excelAdapter.copy();
		String expected = enumValues.get(0).getDisplayLabel() + "," + enumValues.get(1).getDisplayLabel();
	...
	// GKIM: Disabled because this fails with 'IllegalState' error time to time
