...
public class CBRCaseBaseTab extends PowerEditorTab implements PowerEditorTabPanel {
	...
	public CBRCaseBaseTab(CBRCaseBase cb, boolean readOnly) {
		...
		IDNameDescriptionObjectSelectionTable<CBRCaseTableModel, CBRCase> table = new IDNameDescriptionObjectSelectionTable<CBRCaseTableModel, CBRCase>(tableModel, false);
		CBRCaseSelectionPanel selectionPanel = new CBRCaseSelectionPanel(ClientUtil.getInstance().getLabel("label.title.cbr.cases"), table, detailPanel, readOnly);
