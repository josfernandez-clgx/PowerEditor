...
public abstract class ThreeTierPanel<T extends Persistent, B extends ButtonPanel> extends JPanel implements PowerEditorTabPanel {
	...
	protected ThreeTierPanel(PeDataType entityType, AbstractFilterPanel<T, B> filterPanel, AbstractSelectionPanel<T, B> selectionPanel, JPanel workPanel) {
		this(null, entityType, filterPanel, selectionPanel, workPanel);
	}

	protected ThreeTierPanel(GenericEntityType genericEntityType, AbstractFilterPanel<T, B> filterPanel, AbstractSelectionPanel<T, B> selectionPanel, JPanel workPanel) {
		this(genericEntityType, null, filterPanel, selectionPanel, workPanel);
	}

	private ThreeTierPanel(GenericEntityType genericEntityType, PeDataType entityType, AbstractFilterPanel<T, B> filterPanel, AbstractSelectionPanel<T, B> selectionPanel, JPanel workPanel) {
