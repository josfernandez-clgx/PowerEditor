...
public class TimedAssociationEditDialog extends JPanel {
	...
	public static TimedAssociationKey newAssociation(String entityName, IDNameObjectComboBox<DateSynonym> combo, TimedAssociationKeyFactory takFactory) {
		...
		int option = JOptionPane.showConfirmDialog(ClientUtil.getApplet(), dialog, "New " + entityName + " Association", JOptionPane.OK_CANCEL_OPTION, JOptionPane.PLAIN_MESSAGE);
