 ...
 */
public abstract class IDNameDescriptionObjectDetailPanel<T extends AbstractIDNameDescriptionObject, B extends ButtonPanel> extends IDNameObjectDetailPanel<T, B> {
	/**
	 * 
	 */
	...
	public IDNameDescriptionObjectDetailPanel(PeDataType entityType) {
		super(entityType);
	}
	...
	public void populateForClone(T object) {
		...
		this.descField.setText(((AbstractIDNameDescriptionObject) object).getDescription() + Constants.COPY_TEXT);
	}
