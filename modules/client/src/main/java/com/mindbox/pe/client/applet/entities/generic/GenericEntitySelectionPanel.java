...
public class GenericEntitySelectionPanel extends IDNameObjectSelectionPanel<GenericEntity, EntityManagementButtonPanel<GenericEntity>> {
	...
	public static GenericEntitySelectionPanel createInstance(GenericEntityType type, boolean canClone, GenericEntityDetailPanel detailPanel, boolean readOnly) {
	...
	protected void createButtonPanel() {
		this.buttonPanel = new EntityManagementButtonPanel<GenericEntity>(isReadOnly(), this, currentType, ClientUtil.getInstance().getLabel(currentType), currentCanClone, true);
