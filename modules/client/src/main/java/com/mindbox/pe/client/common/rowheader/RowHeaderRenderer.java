...
class RowHeaderRenderer extends DefaultTableCellRenderer implements ListCellRenderer {
	...
	public void updateUI() {
		...
		noFocusBorder = new javax.swing.plaf.BorderUIResource.CompoundBorderUIResource(border, BorderFactory.createEmptyBorder(insets.top, insets.left, insets.bottom, insets.right));
	}
