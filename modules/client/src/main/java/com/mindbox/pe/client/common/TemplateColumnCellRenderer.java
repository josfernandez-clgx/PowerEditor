...
public class TemplateColumnCellRenderer extends DefaultListCellRenderer implements ListCellRenderer {
	...
	private String getDisplayValue(Object value) {
		...
		if (value instanceof AbstractTemplateColumn) return String.format("%s (%d)", ((AbstractTemplateColumn) value).getTitle(), ((AbstractTemplateColumn) value).getColumnNumber());
