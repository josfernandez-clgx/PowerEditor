...
public class MultiSelectCategoryOrEntityCellEditor extends AbstractCellEditor {
	...
	private JButton selectAllEntitiesButton = UIFactory.createButton("", "image.btn.checkall", null, "button.tooltip.select.all.entities", false);
	private JButton clearAllButton = UIFactory.createButton("", "image.btn.small.clear", null, "button.tooltip.clearall", false);

	public MultiSelectCategoryOrEntityCellEditor(String columnTitle, GenericEntityType entityType, boolean allowEntity, boolean viewOnly, AbstractGridTableModel<?> tableModel, boolean sort) {
	...
	private void refreshEditorComponentText() {
		...
		editorComponent.setText((categoryOrEntityValues == null ? null : CategoryEntityMultiSelectCellRenderer.getDisplayValue(categoryOrEntityValues, true, false)));
	}
