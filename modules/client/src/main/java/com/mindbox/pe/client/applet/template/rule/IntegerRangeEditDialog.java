...
public class IntegerRangeEditDialog extends JPanel {
	...
	public static String editRange(JDialog parent, String valueStr) {
		...
		int option = JOptionPane.showConfirmDialog(parent, dialog, "Integer Range Editor", JOptionPane.OK_CANCEL_OPTION, JOptionPane.PLAIN_MESSAGE, null);
	...
	private String extractSelectedValues() {
		...
		else if (min != null && max != null && max.intValue() - min.intValue() < 2 && !lowerInclCheckBox.isSelected() && !upperInclCheckBox.isSelected()) {
