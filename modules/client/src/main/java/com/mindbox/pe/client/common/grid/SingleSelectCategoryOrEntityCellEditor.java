...
public class SingleSelectCategoryOrEntityCellEditor extends AbstractSingleSelectCategoryOrEntityCellEditor {
	...
	private static final Logger LOG = Logger.getLogger(SingleSelectCategoryOrEntityCellEditor.class);
	...
	public SingleSelectCategoryOrEntityCellEditor(String columnTitle, GenericEntityType entityType, boolean allowEntity, boolean viewOnly, AbstractGridTableModel<?> tableModel, boolean sort) {
	...
	protected CategoryOrEntityValue getCategoryOrEntityValueFromGUI() {
		...
		if (selectionTree != null) {
			...
			if (entity != null) {
				categoryOrEntityValue = new CategoryOrEntityValue(entityType, true, entity.getID());
			}
			else {
				GenericCategory category = selectionTree.getSelectedGenericCategory();
				if (category != null) {
					categoryOrEntityValue = new CategoryOrEntityValue(entityType, false, category.getID());
				}
			}
		}
		return categoryOrEntityValue;
	}
	...
	protected void setInternals(CategoryOrEntityValue categoryOrEntityValue) {
		logInfo(LOG, "setInternals: %s", categoryOrEntityValue);
		if (selectionTree != null) {
