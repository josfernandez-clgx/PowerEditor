...
interface OperatorHelper {
	 ...
	 */
	ValueAndComment formatForPattern(Object value, int op, String attribVarName, boolean asString, Reference reference, TimeSlice timeSlice, Integer precision) throws RuleGenerationException;
}
