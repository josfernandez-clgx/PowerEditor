...
public class WriteContextTag extends AbstractValueTag {
	...
	public static final String toContextTagValue(CategoryOrEntityValue categoryOrEntityValue) {
	...
	static final String toContextTagValue(GenericEntityType entityType, int id, boolean forEntity) {
		return toContextTagValue(entityType, new int[] { id }, forEntity);
	}

	private static String toContextTagValue(GenericEntityType entityType, int[] ids, boolean forEntity) {
		StringBuilder buff = new StringBuilder();
		appendContextTagValue(buff, entityType, ids, forEntity);
		return buff.toString();
	}

	private static void appendContextTagValue(StringBuilder buff, GenericEntityType entityType, int[] ids, boolean forEntity) {
		...
		if (forEntity) {
			...
			CategoryType categoryTypeDefinition = CategoryTypeDefinitionTag.getCategoryTypeDefinition(entityType.getCategoryType());
