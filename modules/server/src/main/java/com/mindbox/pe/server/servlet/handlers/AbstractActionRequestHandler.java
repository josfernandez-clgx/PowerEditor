...
public abstract class AbstractActionRequestHandler<T extends RequestComm<?>> implements IRequestCommHandler<T> {
	...
	protected final ErrorResponse generateErrorResponse(ExportException ex) {
		...
		ErrorResponse errorresponsecomm = new ErrorResponse(ErrorResponse.SERVER_ERROR, "msg.error.generic.service", new Object[] { ex.getMessage() });
	 ...
	 * @param requestcomm requestcomm
	 * @param httpservletrequest httpservletrequest
	 * @return response
	 * @throws DataValidationFailedException on validation error
	 * @throws LockException lock error
