...
IF (EXISTS (SELECT * 
                 ...
                 AND  TABLE_NAME = 'POWEREDITOR_USER_TRACKING'))
BEGIN
	insert into POWEREDITOR_USER_TRACKING (USERNAME, USERDISABLED, USERDISABLEDDATE, USERLASTLOGINDATE, USERCREATEDATE, USERLASTMODIFIEDDATE , MODIFIEDBY, ENABLED_DATE )
	values ('admin', 0, null, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'admin', CURRENT_TIMESTAMP);
END