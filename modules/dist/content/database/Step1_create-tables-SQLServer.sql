...
CREATE TABLE MB_GUIDELINE_ACTION (
	...
	deployment_rule VARCHAR(4000) NULL ,
...
CREATE TABLE MB_TEMPLATE_DEPLOY_RULE (
	template_id     INT NOT NULL ,
	column_no       INT NOT NULL ,
	rule_def        VARCHAR(8000) NULL ,
	big_rule_def	IMAGE NULL
);
...
CREATE TABLE MB_TYPE_ENUM (
    ...
    enum_disp_label VARCHAR(100) NULL ,
