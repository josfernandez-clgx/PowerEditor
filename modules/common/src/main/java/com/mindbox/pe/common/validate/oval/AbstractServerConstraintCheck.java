...
public abstract class AbstractServerConstraintCheck<ConstraintAnnotation extends Annotation> extends AbstractAnnotationCheck<ConstraintAnnotation> {
	...
	public boolean isSatisfied(Object validatedObject, Object valueToValidate, OValContext context, Validator validator) throws OValException {
		...
		try {
			...
			if (ServerConstraintCheck.class.isAssignableFrom(constraintCheckClass)) {
				...
				throw new OValException(serverConstraintCheckClassName + " does not implement " + ServerConstraintCheck.class.getName());
			}
		}
