...
public class DateTimeRange extends AbstractRange {
	...
	public String toString() {
		...
		if (lowerVal != null) {
			...
			buff.append(Constants.THREADLOCAL_FORMAT_DATE_TIME_SEC.get().format(lowerVal));
		}
		else {
			buff.append(" ");
		}
		buff.append("-");
		if (upperVal != null) {
			buff.append(Constants.THREADLOCAL_FORMAT_DATE_TIME_SEC.get().format(upperVal));
	...
	public Object valueOf(String str) throws Exception {
		return Constants.THREADLOCAL_FORMAT_DATE_TIME_SEC.get().parse(str);
	}
