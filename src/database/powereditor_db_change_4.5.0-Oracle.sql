...
ALTER TABLE MB_CBR_ATTRIBUTE MODIFY display_name varchar2(255);
ALTER TABLE MB_CBR_ATTRIBUTE_TYPE MODIFY display_name varchar2(255);
ALTER TABLE MB_CBR_ATTRIBUTE_VALUE MODIFY display_name varchar2(255);
ALTER TABLE MB_CBR_CASE MODIFY display_name varchar2(255);
ALTER TABLE MB_CBR_CASE_ACTION MODIFY display_name varchar2(255);
ALTER TABLE MB_CBR_CASE_BASE MODIFY display_name varchar2(255);
ALTER TABLE MB_CBR_CASE_CLASS MODIFY display_name varchar2(255);
ALTER TABLE MB_CBR_ENUMERATED_VALUE MODIFY value_string varchar2(255);
ALTER TABLE MB_CBR_SCORING_FUNCTION MODIFY display_name varchar2(255);
ALTER TABLE MB_CBR_VALUE_RANGE MODIFY display_name varchar2(255);
ALTER TABLE MB_ENTITY MODIFY entity_name varchar2(255);
ALTER TABLE MB_ENTITY_CATEGORY MODIFY category_name varchar2(255);
ALTER TABLE MB_GUIDELINE_ACTION MODIFY action_name varchar2(255);
ALTER TABLE MB_GUIDELINE_ACTION_PARAM MODIFY param_name varchar2(255);
ALTER TABLE MB_GUIDELINE_TEST_CONDITION MODIFY test_name varchar2(255);
ALTER TABLE MB_NAMED_FILTER MODIFY name varchar2(255);
ALTER TABLE MB_PHASE MODIFY phase_name varchar2(255);
ALTER TABLE MB_PRIVILEGE MODIFY privilege_name varchar2(255);
ALTER TABLE MB_REQUEST MODIFY request_name varchar2(255);
ALTER TABLE MB_REQUEST MODIFY display_name varchar2(255);
ALTER TABLE MB_ROLE MODIFY role_name varchar2(255);
ALTER TABLE MB_TEMPLATE MODIFY name varchar2(255);
ALTER TABLE MB_TEMPLATE MODIFY description varchar2(1000);
ALTER TABLE MB_TEMPLATE_COLUMN MODIFY column_name varchar2(255);
ALTER TABLE MB_TEMPLATE_COLUMN MODIFY title varchar2(255);
ALTER TABLE MB_TEMPLATE_COLUMN MODIFY precision_val INT;
