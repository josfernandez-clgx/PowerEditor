...
CREATE TABLE MB_KB_AUDIT_DETAIL_DATA (
	...
	element_value      VARCHAR(4000) NULL
)
...
CREATE TABLE MB_TEMPLATE_COLUMN (
	...
	multi_select  NUMERIC(1) NULL ,
	allow_blank   NUMERIC(1) NULL ,
	sort_enum     NUMERIC(1) NULL ,
	show_lhs_attr NUMERIC(1) NULL ,
