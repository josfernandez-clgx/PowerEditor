...
ALTER TABLE MB_CBR_ATTRIBUTE ALTER COLUMN display_name varchar(255);
ALTER TABLE MB_CBR_ATTRIBUTE_TYPE ALTER COLUMN display_name varchar(255);
ALTER TABLE MB_CBR_ATTRIBUTE_VALUE ALTER COLUMN display_name varchar(255);
ALTER TABLE MB_CBR_CASE ALTER COLUMN display_name varchar(255);
ALTER TABLE MB_CBR_CASE_ACTION ALTER COLUMN display_name varchar(255);
ALTER TABLE MB_CBR_CASE_BASE ALTER COLUMN display_name varchar(255);
ALTER TABLE MB_CBR_CASE_CLASS ALTER COLUMN display_name varchar(255);
ALTER TABLE MB_CBR_ENUMERATED_VALUE ALTER COLUMN value_string varchar(255);
ALTER TABLE MB_CBR_SCORING_FUNCTION ALTER COLUMN display_name varchar(255);
ALTER TABLE MB_CBR_VALUE_RANGE ALTER COLUMN display_name varchar(255);
ALTER TABLE MB_ENTITY ALTER COLUMN entity_name varchar(255);
ALTER TABLE MB_ENTITY_CATEGORY ALTER COLUMN category_name varchar(255);
ALTER TABLE MB_GUIDELINE_ACTION ALTER COLUMN action_name varchar(255);
ALTER TABLE MB_GUIDELINE_ACTION_PARAM ALTER COLUMN param_name varchar(255);
ALTER TABLE MB_GUIDELINE_TEST_CONDITION ALTER COLUMN test_name varchar(255);
ALTER TABLE MB_NAMED_FILTER ALTER COLUMN name varchar(255);
ALTER TABLE MB_PHASE ALTER COLUMN phase_name varchar(255);
ALTER TABLE MB_PRIVILEGE ALTER COLUMN privilege_name varchar(255);
ALTER TABLE MB_REQUEST ALTER COLUMN request_name varchar(255);
ALTER TABLE MB_REQUEST ALTER COLUMN display_name varchar(255);
ALTER TABLE MB_ROLE ALTER COLUMN role_name varchar(255);
ALTER TABLE MB_TEMPLATE ALTER COLUMN name varchar(255);
ALTER TABLE MB_TEMPLATE ALTER COLUMN description TEXT;
ALTER TABLE MB_TEMPLATE_COLUMN ALTER COLUMN column_name varchar(255);
ALTER TABLE MB_TEMPLATE_COLUMN ALTER COLUMN title varchar(255);
ALTER TABLE MB_TEMPLATE_COLUMN ALTER COLUMN precision_val INT;
