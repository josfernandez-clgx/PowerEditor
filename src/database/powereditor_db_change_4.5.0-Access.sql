...
ALTER TABLE MB_CBR_ATTRIBUTE ALTER display_name varchar(255);
ALTER TABLE MB_CBR_ATTRIBUTE_TYPE ALTER display_name varchar(255);
ALTER TABLE MB_CBR_ATTRIBUTE_VALUE ALTER display_name varchar(255);
ALTER TABLE MB_CBR_CASE ALTER display_name varchar(255);
ALTER TABLE MB_CBR_CASE_ACTION ALTER display_name varchar(255);
ALTER TABLE MB_CBR_CASE_BASE ALTER display_name varchar(255);
ALTER TABLE MB_CBR_CASE_CLASS ALTER display_name varchar(255);
ALTER TABLE MB_CBR_ENUMERATED_VALUE ALTER value_string varchar(255);
ALTER TABLE MB_CBR_SCORING_FUNCTION ALTER display_name varchar(255);
ALTER TABLE MB_CBR_VALUE_RANGE ALTER display_name varchar(255);
ALTER TABLE MB_ENTITY ALTER entity_name varchar(255);
ALTER TABLE MB_ENTITY_CATEGORY ALTER category_name varchar(255);
ALTER TABLE MB_GUIDELINE_ACTION ALTER action_name varchar(255);
ALTER TABLE MB_GUIDELINE_ACTION_PARAM ALTER param_name varchar(255);
ALTER TABLE MB_GUIDELINE_TEST_CONDITION ALTER test_name varchar(255);
ALTER TABLE MB_NAMED_FILTER ALTER name varchar(255);
ALTER TABLE MB_PHASE ALTER phase_name varchar(255);
ALTER TABLE MB_PRIVILEGE ALTER privilege_name varchar(255);
ALTER TABLE MB_REQUEST ALTER request_name varchar(255);
ALTER TABLE MB_REQUEST ALTER display_name varchar(255);
ALTER TABLE MB_ROLE ALTER role_name varchar(255);
ALTER TABLE MB_TEMPLATE ALTER name varchar(255);
ALTER TABLE MB_TEMPLATE ALTER description MEMO;
ALTER TABLE MB_TEMPLATE_COLUMN ALTER column_name varchar(255);
ALTER TABLE MB_TEMPLATE_COLUMN ALTER title varchar(255);
