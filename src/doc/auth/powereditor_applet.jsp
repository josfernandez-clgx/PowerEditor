...
<c:choose>
	...
	<c:otherwise>	
		...
		<c:set var="logoutUrl" value="${configuration.sessionConfiguration.logoutUrlToUse}" />
		<c:url var="contextPath" value="/" />
		<c:set var="archivePaths" value="${contextPath}PowerEditor.jar" />
		<%-- <c:set var="archivePaths" value="${contextPath}PowerEditor.jar,${contextPath}powereditor-parser.jar,${contextPath}net.sf.oval_1.0.jar,${contextPath}MDateSelector.jar,${contextPath}log4j-1.2.8.jar" /> --%>
