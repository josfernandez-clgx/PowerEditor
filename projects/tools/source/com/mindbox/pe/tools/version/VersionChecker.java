...
public class VersionChecker {
	...
	private static final String WEBINF_LIB_PATH = System.getProperty("file.separator") + "WEB-INF" + System.getProperty("file.separator") + "lib"
			+ System.getProperty("file.separator") + JAR_NAME;
	...
	private String extractServerJarPath(String peDir) {
		...
		if (candidate.exists()) {
			...
			candidate = new File(file, System.getProperty("file.separator") + "powereditor" + WEBINF_LIB_PATH);
			if (candidate.exists()) {
				return candidate.getAbsolutePath();
			}
			else {
