 ...
 * </PRE>
 */
public class ReferenceInArgument implements Node {
   private Node parent;
   public NodeToken f0;
   public NodeToken f1;
   ...
   public ReferenceInArgument(NodeToken n0, NodeToken n1, NodeListOptional n2, NodeToken n3) {
      f0 = n0;
   ...
   public ReferenceInArgument(NodeToken n0, NodeListOptional n1) {
      f0 = new NodeToken("|");
      if ( f0 != null ) f0.setParent(this);
      f1 = n0;
      if ( f1 != null ) f1.setParent(this);
