...
public class UtilBase {
	...
	public static String constructViewGuidelinePrivilege_DisplayName(String privilege) {
		return PrivilegeConstants.VIEW_PRIV_DISPLAY_NAME_PREFIX + privilege
				+ PrivilegeConstants.VIEW_AND_EDIT_USAGE_GUIDELINE_PRIV_DISPLAY_NAME_SUFFIX;
	}
	...
	public static String constructEditGuidelinePrivilege_DisplayName(String privilege) {
		return PrivilegeConstants.EDIT_PRIV_DISPLAY_NAME_PREFIX + privilege
				+ PrivilegeConstants.VIEW_AND_EDIT_USAGE_GUIDELINE_PRIV_DISPLAY_NAME_SUFFIX;
	}
	...
	public static String constructViewTemplatesPrivilege_DisplayName(String privilege) {
		return PrivilegeConstants.VIEW_PRIV_DISPLAY_NAME_PREFIX + privilege
				+ PrivilegeConstants.VIEW_AND_EDIT_USAGE_TEMPLATE_PRIV_DISPLAY_NAME_SUFFIX;
	}
