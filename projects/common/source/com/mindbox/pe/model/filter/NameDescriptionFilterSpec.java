...
public class NameDescriptionFilterSpec<T extends AbstractIDNameDescriptionObject> extends NameFilterSpec<T> {
	 ...
	 */
	public NameDescriptionFilterSpec(EntityType entityType, GenericEntityType genericEntityType, String name) {
	 ...
	 *            the name of this filter spec
	 */
	public NameDescriptionFilterSpec(EntityType entityType, GenericEntityType genericEntityType, int filterID, String name) {
