...
public class NameFilterSpec<T extends IDNameObject> extends AbstractPersistentFilterSpec<T> {
	...
	public NameFilterSpec(EntityType entityType, GenericEntityType genericEntityType, String name) {
		super(entityType, genericEntityType, name);
	}

	public NameFilterSpec(EntityType entityType, GenericEntityType genericEntityType, int filterID, String name) {
