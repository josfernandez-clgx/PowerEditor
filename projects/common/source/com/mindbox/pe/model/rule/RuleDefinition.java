...
import com.mindbox.pe.model.ColumnReferenceContainer;
...
public class RuleDefinition extends AbstractIDNameDescriptionObject implements ColumnReferenceContainer {
	...
	public RuleDefinition(RuleDefinition source) {
		this(source.getID(), source.getName(), source.getDescription(), RuleElementFactory.deepCopyCompoundLHSElement(source.rootCondition),
	...
	private boolean hasConditionForReference(Condition condition, Reference ref) {
		return ref.equals(condition.getReference())
				|| (UtilBase.isEmpty(ref.getAttributeName()) && condition.getReference().getClassName() != null && condition.getReference().getClassName().equals(
						ref.getClassName()));
	}
	...
	public boolean equals(Object obj) {
		if (obj instanceof RuleDefinition) { return this.getID() == ((RuleDefinition) obj).getID(); }
		return false;
	}
	...
	public void toDebugString(StringBuffer buff, CompoundLHSElement cle, String pad) {
