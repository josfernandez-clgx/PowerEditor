 ...
 */
public final class GenericCategory extends AbstractIDObject implements IDNameObject, Auditable {
	...
	private GenericCategory(int id, String name, int type, ChildAssociationKeySet childAssociationKeySet,
			ParentAssociationKeySet parentAssociationKeySet) {
		super(id);
		this.name = name;
		this.type = type;
	...
	private GenericCategory(GenericCategory source) {
		this(
				...
				source.getName(),
				source.type,
				new DefaultChildAssociationKeySet(source.childCategories),
				new DefaultParentAssociationKeySet(source.parentCategories));
	}
