...
public interface Communicator {
	...
	boolean checkNameForUniqueness(EntityType entityType, String name) throws ServerException;
	 ...
	 * @since PowerEditor 4.2.0
	 */
	int makeNewVersion(int oldTemplateID, GridTemplate newVersion, DateSynonym cutoverDate) throws ServerException;
	...
	/**
	 * Gerenerate reports of the specified guidelines and returns the URL of the report to display.
	 ...
	 * @since 3.0.0
	 */
	List<GenericEntityCompatibilityData> fetchCompatibilityData(GenericEntityType entityType1, GenericEntityType entityType2)
			throws ServerException;
	...
	void delete(int entityID, EntityType entityType) throws ServerException;
	...
	Persistent fetch(int entityID, EntityType entityType, boolean lockEntity) throws ServerException;

	void lock(int entityID, EntityType entityType) throws ServerException;
	...
	void unlock(int entityID, EntityType entityType) throws ServerException;
	...
	List<GenerateStats> retrieveDeployStats(int i) throws ServerException;
