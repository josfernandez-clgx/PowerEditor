...
public class CategoryToEntityListPanel extends PanelBase {
	...
	public CategoryToEntityListPanel(GenericCategory category) throws ServerException {
		...
		setEnabled(false);
		ComboBoxModel model = EntityModelCacheFactory.getInstance().getGenericEntityComboModel(
	...
	private synchronized void populateData() throws ServerException {
		List<CategoryToEntityAssociationData> dataList = EntityModelCacheFactory.getInstance().getCategoryToEntityAssociationsByCategory(
				category);
