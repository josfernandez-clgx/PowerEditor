...
public class ManageGuidelineTab extends JPanel implements GuidelineGridEditor, ContextChangeListener, EntityDeleteListener,
		PowerEditorTabPanel {
	...
	public ManageGuidelineTab(GuidelineTabConfig[] tabConfigs, boolean readOnly) {
	...
	public void checkTemplateExistence() {
		...
		if (template != null && !EntityModelCacheFactory.getInstance().getAllGuidelineTemplates().contains(template))
