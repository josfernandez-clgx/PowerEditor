...
class GenericEntityToCategoryPanel extends JPanel {
	        ...
	        public void valueChanged(ValueChangeEvent e) {
	            ...
	            if (categoryAssociationsPanel.getCategoryAssociations() != null) {
	                for (Iterator<MutableTimedAssociationKey> i = categoryAssociationsPanel.getCategoryAssociations().iterator(); i.hasNext();) {
	                    ...
	                    if (asOfDate == null || ((key.getEffectiveDate() == null || !key.getEffectiveDate().getDate().after(asOfDate)) &&
	                            (key.getExpirationDate() == null || !key.getExpirationDate().getDate().before(asOfDate)))) {
    ...
    private void initDialog() {
        ...
        categoriesTreeField.addTreeModelListener(new TreeModelListener() {
            ...
            public void treeStructureChanged(TreeModelEvent e) {
                if (entity != null) {
                    setCategorySelection(entity.getCategoryIDList(
                            categoriesTreeField.getSelectedDate()));
                }
            }
        });
    }
    ...
    public void setEntity(GenericEntity entity) {
        ...
        if (entity != null) {
            categoriesTreeField.setSelectedCategoriesAndEntities(entity.getCategoryIDList(
                    categoriesTreeField.getSelectedDate()), null);
