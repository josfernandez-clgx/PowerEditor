...
public abstract class FunctionDetailsPanel<T extends FunctionTypeDefinition> extends IDNameDescriptionObjectDetailPanel<T,EntityManagementButtonPanel<T>> 
	implements ValueChangeListener, ListSelectionListener {
	...
	public FunctionDetailsPanel(EntityType et) {
		super(et);
