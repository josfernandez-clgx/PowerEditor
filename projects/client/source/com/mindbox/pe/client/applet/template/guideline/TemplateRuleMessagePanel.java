...
class TemplateRuleMessagePanel extends PanelBase {
	...
	private static final MessageFormat validateMessageFormat = new MessageFormat("* Validataion Failed *"
			+ System.getProperty("line.separator") + System.getProperty("line.separator") + "Error Type   : {0}"
			+ System.getProperty("line.separator") + "Error Message: {1}" + System.getProperty("line.separator")
	...
	private class MessageActionL extends Action3Adapter {
		...
		public void editPerformed(ActionEvent e) {
			...
			if (digest != null) {
				TemplateMessageDigest changedDigest = MessageEditDialog.editTemplateMessageDigest(
						...
						template,
						digest, ruleForTemplateRadio.isSelected());
		...
		public void newPerformed(ActionEvent e) {
			TemplateMessageDigest digest = MessageEditDialog.createTemplateMessageDigest(
					JOptionPane.getFrameForComponent(ClientUtil.getApplet()),
					currentScope instanceof GridTemplate, template, ruleForTemplateRadio.isSelected());
			if (digest != null) {
