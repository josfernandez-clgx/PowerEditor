...
public class GenericEntityManagementPanel extends ThreeTierPanel<GenericEntity, EntityManagementButtonPanel<GenericEntity>> {
	...
	public static GenericEntityManagementPanel createInstance(GenericEntityType type, int categoryType, boolean canClone, boolean readOnly) {
		...
		GenericEntityManagementPanel genericEntityPanel = new GenericEntityManagementPanel(
				type,
				categoryType,
				filterPanel,
				selectionPanel,
	 ...
	 * @param workPanel
	 */
	private GenericEntityManagementPanel(GenericEntityType entityType, int categoryType,
			AbstractFilterPanel<GenericEntity, EntityManagementButtonPanel<GenericEntity>> filterPanel,
