...
final class PhaseTree extends JTree {
	...
	private class PhaseTreeCellRenderer extends DefaultTreeCellRenderer {
		...
		public Component getTreeCellRendererComponent(JTree jtree, Object obj, boolean flag, boolean flag1, boolean flag2, int i,
				boolean flag3) {
			String value = null;
			if (obj instanceof PhaseNode) {
				...
				value = phase.getDisplayName() + " ("
						+ (phase.getPhaseTask() == null ? "has no task" : "task: " + phase.getPhaseTask().getName()) + ")";
			}
			else {
				value = obj.toString();
			}
