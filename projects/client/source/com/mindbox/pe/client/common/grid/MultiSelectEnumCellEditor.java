...
public class MultiSelectEnumCellEditor extends AbstractCellEditor {
	...
	public MultiSelectEnumCellEditor(String columnName, ColumnDataSpecDigest columnDataSpecDigest, boolean viewOnly,
	...
	private final void refreshInternals() {
		...
		/*
		ClientUtil.getLogger().debug("Button text is now " + button.getText());
		
		ClientUtil.getLogger().debug("Calling repaint...");
		button.invalidate();
		button.repaint(button.getBounds());
		button.repaint();
		*/
