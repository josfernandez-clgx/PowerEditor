...
public class CheckList extends JList {
	...
	protected String getListText(Object obj) {
		return (obj instanceof GridTemplateColumn ? ((GridTemplateColumn) obj).getTitle() 
				: ((obj instanceof Privilege) ? ((Privilege) obj).getDisplayString()
				: ((obj instanceof IDNameObject) ? ((IDNameObject) obj).getName()
				: ((obj instanceof TemplateUsageType) ? ((TemplateUsageType) obj).getDisplayName() 
				: obj.toString()
				)
				)));
	}
