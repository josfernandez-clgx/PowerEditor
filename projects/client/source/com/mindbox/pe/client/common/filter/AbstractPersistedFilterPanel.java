...
public abstract class AbstractPersistedFilterPanel<T extends Persistent,B extends ButtonPanel> extends AbstractFilterPanel<T,B> {
	...
	protected final EntityType filterEntityType;
	 ...
	 */
	protected AbstractPersistedFilterPanel(AbstractSelectionPanel<T,B> selectionPanel, EntityType filterEntityType, boolean hideManagementButtons) {
	 ...
	 * @param selectionPanel
	 */
	protected AbstractPersistedFilterPanel(AbstractSelectionPanel<T,B> selectionPanel, GenericEntityType filterGenericEntityType,
			boolean hideManagementButtons) {
		this(selectionPanel, null, filterGenericEntityType, hideManagementButtons);
	}

	private AbstractPersistedFilterPanel(AbstractSelectionPanel<T,B> selectionPanel, EntityType filterEntityType,
			GenericEntityType filterGenericEntityType, boolean hideManagementButtons) {
		...
		if (filterGenericEntityType != null) {
			filterButtonStr = ClientUtil.getInstance().getLabel(
					"button.search." + filterGenericEntityType.toString(),
					"Search " + filterGenericEntityType.getDisplayName());
		}
		else {
