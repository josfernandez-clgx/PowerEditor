...
public final class TypeEnumValueComboBox extends JComboBox {
	...
	/*
	public TypeEnumValueComboBox(String typeKey) {
		this(typeKey, false, true);
	}
	
	public TypeEnumValueComboBox(String typeKey, boolean hasEmptyValue, boolean sortValues) {
		this(EntityModelCacheFactory.getInstance().getTypeEnumComboModel(typeKey, hasEmptyValue, sortValues));
	}*/
