...
public final class NavigationPanel extends JPanel implements IFilterSubpanel<GenericEntity> {
	...
	private class NavigationTreeCellRenderer extends DefaultTreeCellRenderer {
		...
		public Component getTreeCellRendererComponent(JTree jtree, Object obj, boolean flag, boolean flag1, boolean flag2, int i, boolean flag3) {
			...
			if (obj1 instanceof IDNameObject)
				obj1 = ((IDNameObject) obj1).getName();
	...
	private void initComponents() {
		...
		fetchButton = UIFactory.createButton(ClientUtil.getInstance().getLabel(
				"button.search." + entityType.toString(),
				"Search " + entityType.getDisplayName()), null, null, null);
	}
	...
	private TreeModel createCloneTreeModel() {
		...
		String s = "<html><b><font size=3 color=#000000 face=arial,geneva>" + ClientUtil.getInstance().getLabel("label.node.clone.root")
				+ "</font></b></html>";
		...
		if (clonenavigationnode != null)
			rootnavigationnode.add(clonenavigationnode);
