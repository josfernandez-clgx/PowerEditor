...
@XmlRootElement(name = "importEntitiesWithCredentialsResponse", namespace = "http://webservices.server.pe.mindbox.com/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "importEntitiesWithCredentialsResponse", namespace = "http://webservices.server.pe.mindbox.com/")
public class ImportEntitiesWithCredentialsResponse {
