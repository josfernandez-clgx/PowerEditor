...
public class AttributeReferenceFinder extends ObjectDepthFirst {
	...
	private void process(Condition condition) {
		...
		if (condition != null && condition.getReference() != null && condition.getValue() != null
				&& condition.getValue() instanceof ColumnReference) {

			storeRefMap(condition.getReference().getClassName(), condition.getReference().getAttributeName(),
					((ColumnReference) condition.getValue()).getColumnNo());
		}
	}
	...
	public Object visit(UnaryExpression unaryexpression, Object obj) {
		if (obj instanceof AeAttributePattern) {
			...
			logger.warn("Passthrough for visit(UnaryExpression,Object): unknown arg type: " + obj + " - "
	...
	private Object visit(ConditionalExpression conditionalexpression,
	...
	private Object visit(ConditionalAndExpression conditionalandexpression,
			AbstractAeCompoundCondition abstractaecompoundcondition) {
		Object obj = null;
	...
	private Object visit(RelationalExpression relationalexpression,
			AbstractAeCompoundCondition abstractaecompoundcondition) {
		logger.debug("visit(RelationalExpression,AbstractAeCompoundCondition): " + relationalexpression + ","
				+ abstractaecompoundcondition);
		Object obj = null;
	...
	private String findClassName(AeAttributePattern aeattributepattern) {
		if (aeattributepattern.getClassName() != null) {
			...
			logger.info("findClassName: parent of " + aeattributepattern + " is "
					+ aeattributepattern.getParentCondition());
