...
class DynamicStringValueHelper extends AbstractWriteValueHelper<DynamicStringValue> {
	...
	@Override
	public void writeValue(StringBuilder buff, DynamicStringValue dsValue, AbstractTemplateColumn column, boolean addQuotes,
		...
		if (values == null || values.length == 0) {
			...
			buff.append(ConfigurationManager.getInstance().getRuleGenerationConfigurationDefault().getMessageFormatConversionFunction());
			buff.append(' ');
