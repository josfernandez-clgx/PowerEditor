		...
		encryptButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent event) {
				...
				if (pwdServerConfig.isSelected()) {
					final Password pwd = Password.fromClearText(clearTextPwd);
					outputField.setText(pwd.getEncrypted());
				}
				else {
					try {
						String oneWayHashString = PasswordOneWayHashUtil.convertToOneWayHash(clearTextPwd, PasswordOneWayHashUtil.HASH_ALGORITHM_MD5);
