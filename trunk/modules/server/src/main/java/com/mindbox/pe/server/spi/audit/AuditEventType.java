...
public final class AuditEventType implements java.io.Serializable {
	...
	public static final AuditEventType DEPLOY_STARTED = new AuditEventType(6, "Deployment Started");
	public static final AuditEventType DEPLOY_COMPLETED = new AuditEventType(7, "Deployment Completed");
