...
public class ServerContextUtil {
	 ...
	 */
	public static <C extends AbstractTemplateColumn> List<Integer> findMatchingGridRows(GuidelineContext[] contexts, AbstractGrid<C> grid, boolean includeParents, boolean includeChildren,
