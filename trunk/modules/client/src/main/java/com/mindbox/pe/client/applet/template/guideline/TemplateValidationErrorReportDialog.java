...
public class TemplateValidationErrorReportDialog extends JPanel {
	...
	private void initComponents() {
		saveReportButton = UIFactory.createButton(ClientUtil.getInstance().getLabel("button.save.report"), null, new SaveReportListener(), "button.save.report");
		saveReportButton.setActionCommand(SAVE_REPORT_ACTION);

		viewReportButton = UIFactory.createButton(ClientUtil.getInstance().getLabel("button.view.report"), null, new ViewReportListener(), "button.view.report");
