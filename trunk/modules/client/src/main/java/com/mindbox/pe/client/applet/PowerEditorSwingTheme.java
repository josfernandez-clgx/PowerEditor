...
public final class PowerEditorSwingTheme extends DefaultMetalTheme {
	...
	private static final Logger LOG = Logger.getLogger(PowerEditorSwingTheme.class);
	...
	static synchronized void resetLookAndFeelSet() {
	 ...
	 */
	public static synchronized void setLookAndFeelToMulti() {
	 ...
	 * Sets the Swing user interface look and feel to that of the OS.
	 */
	public static synchronized void setLookAndFeelToOS() {
		// setting the Windows look and feel
		try {
			if (!isLookAndFeelSet) {
			...
			logWarn(LOG, e, "Failed to set look and feel to OS");
		}
	}
