 ...
 */
public final class ActionSelectionPanel extends IDNameDescriptionObjectSelectionPanel<ActionTypeDefinition, EntityManagementButtonPanel<ActionTypeDefinition>> {
	/**
	 * 
	 */
	...
	public ActionSelectionPanel(ActionDetailsPanel detailPanel, boolean readOnly) {
		super(ClientUtil.getInstance().getLabel("label.title.guideline.actions"), new IDNameDescriptionObjectSelectionTable<ActionSelectionTableModel, ActionTypeDefinition>(
