...
class CategoryToEntitySelectionTableModel extends AbstractSelectionTableModel<CategoryToEntityAssociationData> {
	...
	public CategoryToEntitySelectionTableModel() {
		super(ClientUtil.getInstance().getLabel("label.entity"), ClientUtil.getInstance().getLabel("label.date.activation"), ClientUtil.getInstance().getLabel("label.date.expiration"));
	}
