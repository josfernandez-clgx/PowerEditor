...
public class ValidationErrorReportDialog extends JPanel {
	...
	public static void showErrors(ValidationException validationException, boolean showInvalidData) {
		ClientUtil.getInstance().showAsDialog("d.title.validation.error", true, new ValidationErrorReportDialog(validationException.getViolations(), showInvalidData), true);
	}
