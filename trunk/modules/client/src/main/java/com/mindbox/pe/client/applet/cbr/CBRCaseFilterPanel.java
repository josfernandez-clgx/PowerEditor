...
public class CBRCaseFilterPanel extends IDNameDescriptionObjectFilterPanel<CBRCase, EntityManagementButtonPanel<CBRCase>> implements ActionListener, ChangeListener {
	...
	public CBRCaseFilterPanel(CBRCaseSelectionPanel selectionPanel, boolean hideManagementButtons, CBRCaseBase caseBase) {
		super(selectionPanel, PeDataType.CBR_CASE, hideManagementButtons);
