...
public class ClientTestObjectMother {
	...
	public static EntityProperty createEntityPropertyDefinition(final EntityPropertyType propertyType) {
		return createEntityPropertyDefinition(propertyType, true, true);
	}

	public static EntityProperty createEntityPropertyDefinition(final EntityPropertyType propertyType, boolean required, boolean searchable) {
	...
	public static EntityProperty createEntityPropertyDefinition(final EntityPropertyType propertyType, String name) {
		return createEntityPropertyDefinition(propertyType, name, true, true);
	}

	public static EntityProperty createEntityPropertyDefinition(final EntityPropertyType propertyType, String name, boolean required, boolean searchable) {
		EntityProperty result = new EntityProperty();
		result.setType(propertyType);
		int id = getNextUniqueId();
		result.setName(name);
	...
	private ClientTestObjectMother() {
	}
