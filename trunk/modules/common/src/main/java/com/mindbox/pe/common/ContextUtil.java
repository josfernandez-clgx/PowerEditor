...
public class ContextUtil {
	...
	public static boolean containsContext(GuidelineContext[] container, GuidelineContext context) {
		...
		for (int i = 0; i < container.length; i++) {
			if (context.getGenericEntityType() == container[i].getGenericEntityType()
					&& context.getGenericCategoryType() == container[i].getGenericCategoryType()) {
