...
public class EntityTypeNameOrCategoryCheck extends AbstractAnnotationCheck<EntityTypeNameOrCategory> {
	...
	public boolean isSatisfied(Object validatedObject, Object valueToValidate, OValContext arg2, Validator arg3) throws OValException {
		...
		if (valueToValidate.getClass().equals(String.class)) {
			return "category".equals((String) valueToValidate) || GenericEntityType.forName((String) valueToValidate) != null;
		}
		return false;
	}
