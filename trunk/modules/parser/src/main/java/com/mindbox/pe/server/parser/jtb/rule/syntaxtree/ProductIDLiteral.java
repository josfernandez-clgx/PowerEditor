 ...
 * </PRE>
 */
public class ProductIDLiteral implements Node {
   private Node parent;
   public NodeToken f0;
   public NodeToken f1;
   public NodeToken f2;

   public ProductIDLiteral(NodeToken n0, NodeToken n1, NodeToken n2) {
      f0 = n0;
   ...
   public ProductIDLiteral() {
      f0 = new NodeToken("%");
      if ( f0 != null ) f0.setParent(this);
      f1 = new NodeToken("productID");
      if ( f1 != null ) f1.setParent(this);
      f2 = new NodeToken("%");
      if ( f2 != null ) f2.setParent(this);
   }
