...
public class ReflectionUtil {
	 ...
	 *             wrapped in a RuntimeException if any is not found.
	 */
	...
	public static <T> T getPrivate(Object o, String fieldName, Class<T> c) {
		try {
			...
			if (c.isInstance(obj)) {
				...
				throw new IllegalArgumentException(fieldName + " of " + o.getClass().getName() + " is not an instance of "
						+ c.getClass().getName());
			}
		}
		catch (RuntimeException re) {
	 ...
	 *             if the system SecurityManager denies access.
	 */
	 ...
	 *             if no default constructor exists, it is inaccessible or if the constructor itself
