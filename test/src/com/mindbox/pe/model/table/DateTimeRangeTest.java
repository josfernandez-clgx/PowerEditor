...
public class DateTimeRangeTest extends AbstractTestBase {
	private DateTimeRange range;
	private Date lowerVal, upperVal;

	public static TestSuite suite() {
		TestSuite suite = new TestSuite(DateTimeRangeTest.class.getName());
		suite.addTestSuite(DateTimeRangeTest.class);
		return suite;
	}

	public DateTimeRangeTest(String name) {
		super(name);
	}
	...
	public void testImplementsSerializable() throws Exception {
		Serializable.class.isAssignableFrom(DateTimeRange.class);
	}
