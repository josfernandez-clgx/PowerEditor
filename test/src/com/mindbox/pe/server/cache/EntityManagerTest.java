...
public class EntityManagerTest extends AbstractTestWithTestConfig {
	...
	public static TestSuite suite() {
		TestSuite suite = new TestSuite("EntityManagerTest Tests");
	...
	public void testIsInUseNegativeCase() throws Exception {
		...
		assertFalse(EntityManager.getInstance().isInUse(ObjectMother.createDateSynonym()));
	}

	public void testAddGenericEntityToCategoryWithInvalidIDThrowsIllegalArgumentException() throws Exception {
		assertThrowsException(EntityManager.getInstance(), "addParentAssociation", new Class[] {
				int.class,
				int.class,
				MutableTimedAssociationKey.class }, new Object[] {
				new Integer(categoryType),
				new Integer(-1),
				ObjectMother.createMutableTimedAssociationKey() }, IllegalArgumentException.class);
	}
	...
	public void testAddGenericEntityToCategoryHappyCase() throws Exception {
		...
		GenericEntityIdentity[] identities = EntityManager.getInstance().getGenericEntitiesInCategorySetAsOfWithDescendents(
				categoryType,
				new int[] { 220 },
				new Date(),
				false);
	...
	public void testGetAllCategoriesByNameWithNullNameThrowsNullPointerException() throws Exception {
		assertThrowsNullPointerException(EntityManager.getInstance(), "getAllGenericCategoriesByName", new Class<?>[] {
				int.class,
				String.class }, new Object[] { 0, null });
	}
	...
	public void testGetDateSynonymsForChangesInCategoryRelationshipsHappyCase() throws Exception {
		...
		ds = ObjectMother.createDateSynonym();
	...
	public void testGroupForContextMatchCategoryArgWithOneIDReturnsListWithOneCollection() throws Exception {
		List<Collection<Integer>> list = EntityManager.getInstance().groupForContextMatchCategoryArgAsOf(
				categoryType,
				new int[] { 1 },
				new Date());
		assertEquals(1, list.size());
	...
	public void testGroupForContextMatchCategoryArgHappyCaseForMultipleList() throws Exception {
		...
		for (Iterator<Collection<Integer>> iter = list.iterator(); iter.hasNext();) {
			...
			assertTrue(element.contains(new Integer(100)) && element.size() == 1 || element.contains(new Integer(200))
	...
	public void testSetGenericEntityPropertiesWithStringForDateProperty() throws Exception {
		...
		EntityManager.setGenericEntityProperties(entity1, map);
		assertEquals(cal.getTime(), entity1.getDateProperty(propName));
	}

	public void testGetGenericEntitiesInCategorySetAsOfWithNullCategoryIDsReturnsEmptyArray() throws Exception {
		GenericEntityIdentity[] results = EntityManager.getInstance().getGenericEntitiesInCategorySetAsOfWithDescendents(
				categoryType,
				null,
				new Date(),
				false);
	...
	public void testGetGenericEntitiesInCategorySetAsOfWithParentCategoryReturnsEntitiesInDescendents() throws Exception {
		...
		results = EntityManager.getInstance().getGenericEntitiesInCategorySetAsOfWithDescendents(
				categoryType,
				new int[] { 100 },
				new Date(),
				false);
	...
	public void testGetGenericEntitiesInCategorySetAtAnyTimeHappyCaseWithoutDescendents() throws Exception {
		GenericEntityIdentity[] identities = EntityManager.getInstance().getGenericEntitiesInCategorySetAtAnyTime(
				categoryType,
				new int[] { 220 },
				false);
		assertEquals(2, identities.length);
	...
	public void testGetGenericEntitiesInCategorySetAsOfWithOutDescendantsWithParentCategoryReturnsOnlyEntitiesNotInDescendents()
			throws Exception {
		GenericEntityIdentity[] results = EntityManager.getInstance().getGenericEntitiesInCategorySetAsOfWithOutDescendents(
				categoryType,
				new int[] { 200 },
				new Date());
		assertEquals(1, results.length);

		results = EntityManager.getInstance().getGenericEntitiesInCategorySetAsOfWithOutDescendents(
				categoryType,
	...
	public void testIsDescendentAsOfNegativeCase() throws Exception {
		...
		GenericCategory parent = EntityManager.getInstance().getGenericCategory(categoryType, 1);
		GenericCategory child = EntityManager.getInstance().getGenericCategory(categoryType, 100);
		assertFalse(EntityManager.getInstance().isDescendentAsOf(
				child.getId(),
				parent.getId(),
				parent.getType(),
				new Date(ds.getDate().getTime() + 10)));
	}

	public void testIsDescendentAtAnyTimeWithNullArrayThrowsNullPointerException() throws Exception {
		assertThrowsNullPointerException(EntityManager.getInstance(), "isDescendentAtAnyTime", new Class[] {
				int.class,
				int[].class,
				int.class }, new Object[] { new Integer(1), null, new Integer(categoryType) });
	}
	...
	public void testIsEntityDescendentOfCategorySetAtAnyTimeWithNullIntArrayThrowsNullPointerException() throws Exception {
		assertThrowsNullPointerException(EntityManager.getInstance(), "isEntityDescendentOfCategorySetAtAnyTime", new Class[] {
				int.class,
				int[].class,
				int.class }, new Object[] { new Integer(1), null, new Integer(categoryType) });
	}
	...
	public void testIsEntityDescendentOfCategorySetAtAnyTimePositiveCaseForMultipleCategories() throws Exception {
		...
		assertTrue(EntityManager.getInstance().isEntityDescendentOfCategorySetAtAnyTime(
				entity.getID(),
				new int[] { 222, 100 },
				categoryType));
	}
	...
	public void testGetDateSynonymsForChangesInCategoryToEntityRelationshipsWithNullContextContainerThrowsNullPointerException()
			throws Exception {
		assertThrowsNullPointerException(
				EntityManager.getInstance(),
				"getDateSynonymsForChangesInCategoryToEntityRelationships",
				new Class[] { ContextContainer.class, DateSynonym.class, DateSynonym.class },
	...
	public void testGetDateSynonymsForChangesInCategoryToEntityRelationshipsHappyCase() throws Exception {
		...
		DateSynonym ds4 = ObjectMother.createDateSynonym();
		GenericCategory category = EntityManager.getInstance().getGenericCategory(categoryType, 222);
