...
public class RegexpPasswordValidatorTest extends TestCase {
	...
	public static Test suite() {
		TestSuite suite = new TestSuite(RegexpPasswordValidatorTest.class.getName());
		suite.addTestSuite(RegexpPasswordValidatorTest.class);
		return suite;
	}
	
	public RegexpPasswordValidatorTest(String name) {
		super(name);
	}
